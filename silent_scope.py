...
def main():
    ...
    banner = pyfiglet.figlet_format("Silent Scope", font="slant")
    print(banner)

    # Argument parsing
    parser = argparse.ArgumentParser(description="Silent-Scope | Passive Recon Tool")
    ...
    # Prompt if domain not provided
    if not args.domain:
        args.domain = input("Enter target domain (e.g. example.com): ").strip()
